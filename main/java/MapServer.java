...
public class MapServer {
    ...
    public static void initialize() {
        ...
        tree = new QuadTree2(ROOT_ULLON, ROOT_ULLAT, ROOT_LRLON, ROOT_LRLAT, new File("img/root.png"), 0, 0);
        System.out.println("Done initializing tree");
    }
    ...
    public static Map<String, Object> getMapRaster(Map<String, Double> params, OutputStream os) {
        System.out.println("get Map Raster");
        HashMap<String, Object> rasteredImageParams = new HashMap<>();
//        System.out.println(params.get("ullon") + ", " +params.get("ullat") + ", " +params.get("lrlon") + ", " +params.get("lrlat") + "height : " + params.get("h") + "");
        System.out.println(params);

        double dpp = (params.get("lrlon") - params.get("ullon")) / params.get("w");
        System.out.println("query dpp = " + dpp);

        QuadTreeImage im = tree.getImage(params.get("ullon"), params.get("ullat"), params.get("lrlon"), params.get("lrlat"), dpp);

        BufferedImage image = im.image;
        try {
        ...
        rasteredImageParams.put("raster_ul_lon", im.ullon);
        rasteredImageParams.put("raster_ul_lat", im.ullat);
        rasteredImageParams.put("raster_lr_lon", im.lrlon);
        rasteredImageParams.put("raster_lr_lat", im.lrlat);
        rasteredImageParams.put("raster_width", im.width);
        rasteredImageParams.put("raster_height", im.height);
        rasteredImageParams.put("depth", im.depth);
        rasteredImageParams.put("query_success", im.query);
        System.out.println("rastered params: " + rasteredImageParams);
